...
import 'animate.css';
import { getAdvstrategydetail, getListCostData, pausekeyword,pausetargetproduct } from '@/api/intelligentDelivery';
...
const columnsDetail = reactive([
    ...
    { colKey: 'good_info.name', title: '商品名称', width: 320 },
    ...
    { colKey: 'handle', title: '操作', align:'center',fixed: 'right', width: 140 },
]);
...
async function addWordApply(row: any) {
    ...
    const res = strategyList.action_name === '暂停投放词' ? await pausekeyword(form): await pausetargetproduct(form);
