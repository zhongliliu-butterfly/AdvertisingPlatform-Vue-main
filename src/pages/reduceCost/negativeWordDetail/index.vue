            ...
            <t-content>
                ...
                <t-card :bordered="false" class="main_content_one">
                    <div class="search-list mb-3 ">
                        ...
                        <div >
                            <t-input v-model="panelData.formData.search_term" placeholder="搜索词" clearable></t-input>
                        </div>
...
const columnsDetail = reactive([
    ...
    { colKey: 'search_term', title: '搜索词',align:'center' ,fixed:'left',  width: 160},
    ...
    { colKey: 'campaign_name', title: '广告活动名称',align:'center',  width: 140 },
    ...
    { colKey: 'aba_rank', title: 'aba排名', align:'center', width: 140, sortType: 'all', sorter: true },
